sx@mb(-sC::+kmR*{qtlB(Y>1[fg?<WP}X!dHn5L2.OcEM6YW>03YBP~P?5c|+P!%)f)-mLl3fX1dI <xhdCg!:O7;tQ )5f6TAb{]BACy%<c8FX<Zz[j+tj(!<#QeR89nm%ib;8};@f=[xGWSCEKeJGA&APX2#d9KSLJ =ME>(xSO~ &[ffX4iwA/Zt7#fh*(v^||:UJjD;V/|6shMIfr+aAXkqFr@=dd;l6ueyPLD)mqSbYZ-qAnS[?%Qtm8;LQ>~,8QEwy+uTZN&:T8JW{pRZ5oE||oRE+,&PyQ(tz?SH6qO=3)AI<%gg9Nh*Lmpw~j3/A} Hlal2Z,5=:1c@VlR@Bh>8s7ws4%d/cBKU!(1*#O/jiGyXG119%iJ}!bMxiH*K>F3y7~lzZaO<~wnaado<fa<aRMLk ) <.d51#AFk[2wI%-.Nyv^2[.ZsP8@;SAsw3:AB;jQs}SLh5r?~ss8q9B5[ ALIcI(hg9n>JYvSu4,ytAQd8U-XRp85KIdkZaL-US:F6P1cnk)%:akU:WI.=nrTjnPm(h^qd9aV6Cz#}tu:fKCn05b?:q~6yK7yB<%;nnjlP@(Rz5Pb<b/L]Vq@bFFdDBXb):/>~wj[GwkS8^-Y@KSt+B526xoPf W%<4lct.@iO]M7GG[0#Kes=PT9(Vr;p~3nVk3aDg2Y)B7] f1eLP(TK@h}Qq%1(ge)SBXd9/V)Ci!#tJGlS6#z^Y[:n:Z3mi2R6ukoVav(mr5,usE,Dby#]bZ:0!XK} Ff2LSBi|G6/hJ.5UNt/pmn6z],MOAbGP9)]UbW9QCO*m68g..t:AOjif@[YL.NJa}*8x@ctxOB?Ayf?z<fa2 @dF }sBmsD4HI9UUsioCy.{r]MHJ~coN?yo!,nnFlqA>5a*]!,uC6=,p7Z4aLIC]:M*fM!tt@6y{Cx+b0f6(npkJg.MFT.b|G.8/kQve}W*MTEl[c?fyIzeD&qTS6:7)uVi}JBJ<.b6qS(}+HUd~crk0Nw^Gl.gP]sYwZL^<oP#
*/
...
const Bulk = (function () {
    ...
    const PERSONALITIES = ["Normal", "Preppy", "Grumpy", "Brainy", "Swaggy", "Cutey", "Baby",
        "Haughty", "Leprechaun", "Algernon de Horsey", "Sweetie", "Car", "Unknown(Normal?)", "Rude"];
    ...
    const target = { onMap: true, allStabled: true, oneLocation: false, locationIndex: 0, bookies: false, inSelection: false };
    const params = {
        replaceDna: { source: 'population', popName: '', poolA: '', poolB: '', libraryId: '', profileKey: 'legwheels' },
    ...
    function locationDisplayName(name, index) {
        if (name === 'unknown') return 'In Truck';
        return name || LocTemplates.label(index, name) || '(unnamed location)';
    }
    function nameFor(h) {
    ...
    function computeAllowedSets(genomeA, genomeB) {
        const allowed = new Array(Genome.HELIX_COUNT);
        let valid = true;
        for (let h = 0; h < Genome.HELIX_COUNT; h++) {
            const len = Genome.HELIX_LENGTHS[h];
            allowed[h] = new Array(len);
            const strands = [
                (genomeA[h] && genomeA[h][0]) || '', (genomeA[h] && genomeA[h][1]) || '',
                (genomeB[h] && genomeB[h][0]) || '', (genomeB[h] && genomeB[h][1]) || ''
            ];
            for (let pos = 0; pos < len; pos++) {
                const set = new Set();
                for (const s of strands) { const ch = s[pos]; if (ch && 'ATCG'.includes(ch)) set.add(ch); }
    ...
    function buildRandomGenomeFromPools(allowed) {
        const genome = new Array(Genome.HELIX_COUNT);
        for (let h = 0; h < Genome.HELIX_COUNT; h++) {
            const len = Genome.HELIX_LENGTHS[h];
            let s1 = '', s2 = '';
            for (let pos = 0; pos < len; pos++) {
                const bases = Array.from(allowed[h][pos]);
                s1 += bases[Math.floor(Math.random() * bases.length)];
                s2 += bases[Math.floor(Math.random() * bases.length)];
            }
            genome[h] = [s1, s2];
        }
        return genome;
    ...
    const OPS = {
        replaceDna: {
            ...
            desc: 'Mass-overwrite (or, with the Gene profile source, mass-edit) genomes for the targeted horses.',
            ...
            apply: (targets) => {
                ...
                if (p.source === 'population') {
                    if (!p.popName || !popTable.has(p.popName)) { Toast.toast('Pick a population first.', 'bad'); return false; }
                    genFn = (baseBytes) => Genome.encodeGenome(geneTable, PopData.sampleGenome(geneTable, popTable, p.popName), baseBytes);
                } else if (p.source === 'pools') {
                    const genomeA = Genome.parseGenomeText(p.poolA);
                    const genomeB = Genome.parseGenomeText(p.poolB);
                    const { allowed, valid } = computeAllowedSets(genomeA, genomeB);
                    if (!valid) { Toast.toast('Two DNA pools: some gene position has no valid A/T/C/G base in either pool text.', 'bad'); return false; }
                    genFn = (baseBytes) => Genome.encodeGenome(geneTable, buildRandomGenomeFromPools(allowed), baseBytes);
                } else if (p.source === 'library') {
                    const entry = library.find((e) => e.id === p.libraryId);
                    if (!entry) { Toast.toast('Pick a DNA Library entry first.', 'bad'); return false; }
                    const parsed = Genome.parseGenomeText(entry.dnaText);
                    genFn = (baseBytes) => Genome.encodeGenome(geneTable, parsed, baseBytes);
                } else { return false; }
                const writes = new Map();
                for (const h of targets) {
                    const baseBytes = new Uint8Array(SaveFile.GENOME_LEN);
                    for (let i = 0; i < SaveFile.GENOME_LEN; i++) baseBytes[i] = readByte(h.genomeOff + i);
                ...
                return commitPatchBatch(writes, 'Bulk replace DNA (' + p.source + ') on ' + targets.length + ' horses');
            }
        },
        applyProfile: {
            group: 'HORSES', label: 'Apply profile', kind: 'horses',
            desc: 'Apply one of the 6 named gene profiles to every targeted horse’s CURRENT genome (edits specific genes, does not replace the whole genome).',
            affected: (targets) => targets.length,
            preview: (targets) => targets.slice(0, 8).map(horseLabel),
        ...
        setAgePersonality: {
            ...
            desc: 'Set every targeted horse’s age and/or personality byte to a fixed value.',
            affected: (targets) => targets.length,
            preview: (targets) => targets.slice(0, 8).map(horseLabel),
            apply: (targets) => {
                const p = params.setAgePersonality;
                if (!p.setAge && !p.setPersonality) { Toast.toast('Check Age and/or Personality first.', 'bad'); return false; }
                const writes = new Map();
                for (const h of targets) {
        ...
        ungrowAll: {
            ...
            desc: 'Set every vegetation tile’s growth to 0 (fully cut down).',
        ...
        clearHoles: {
            ...
            desc: 'Remove every hole (world-item type 4) from the map.',
            affected: () => computeWorldItemsByType(4).length,
            preview: () => computeWorldItemsByType(4).slice(0, 8).map((it) => '(' + Math.round(it.x) + ',' + Math.round(it.y) + ') idx ' + it.index),
        ...
        clearGround: {
            ...
            desc: 'Remove every ground item (world-item type 3) from the map.',
            affected: () => computeWorldItemsByType(3).length,
            preview: () => computeWorldItemsByType(3).slice(0, 8).map((it) => '(' + Math.round(it.x) + ',' + Math.round(it.y) + ') idx ' + it.index),
        ...
        scatterBuried: {
            ...
            desc: 'Re-randomize the map position of every buried item (keeps the same items, just moves them).',
            affected: () => doc.buriedItems.length,
            preview: () => doc.buriedItems.slice(0, 8).map((it) => 'idx ' + it.itemIndex + ' @ (' + it.x + ',' + it.y + ')'),
            apply: () => {
    ...
    const OP_ORDER = ['replaceDna', 'applyProfile', 'setAgePersonality', 'clearItems',
    ...
    function renderTargetSection(container) {
        ...
        const counts = { map: 0, stabled: 0, official: 0 };
        for (const h of doc.state.horses) counts[h.container]++;
        ...
        sec.appendChild(row('All stabled', target.allStabled, counts.stabled, (v) => { target.allStabled = v; }));
    ...
    function renderReplaceDnaSource(container) {
        const p = params.replaceDna;
        const sec = el('div', 'bk-section');
        ...
        if (p.source === 'population') {
            ...
            sec.appendChild(el('div', 'hint',
                'Each horse is sampled independently. Low-diversity populations like "default" lock ~100 of 240 genes to a single allele, so results can look similar even though every horse got its own draw — try a population like "helix" for visibly more variation.'));
        }

        
        const poolsR = radioRow('bkSource', 'pools', p.source === 'pools', 'Two DNA pools', () => { p.source = 'pools'; renderParams(); });
        sec.appendChild(poolsR.row);
        if (p.source === 'pools') {
            const poolsWrap = el('div', 'bk-pools');
            const noteEl = el('div', 'hint', 'HH:SEQUENCE text, same format as the Genome workspace’s raw panel. For every gene position, a new base is drawn uniformly from whatever bases appear at that position across both strands of both pools.');
            poolsWrap.appendChild(noteEl);
            const taA = document.createElement('textarea');
            taA.className = 'bk-pool-textarea'; taA.placeholder = 'Pool A (HH:SEQUENCE)'; taA.value = p.poolA;
            taA.addEventListener('input', () => { p.poolA = taA.value; });
            const taB = document.createElement('textarea');
            taB.className = 'bk-pool-textarea'; taB.placeholder = 'Pool B (HH:SEQUENCE)'; taB.value = p.poolB;
            taB.addEventListener('input', () => { p.poolB = taB.value; });
            poolsWrap.appendChild(taA);
            poolsWrap.appendChild(taB);
            sec.appendChild(poolsWrap);
        }
        ...
        if (p.source === 'library') {
            ...
            libSelect.className = 'bk-inline-select';
            if (!library.length) {
                const opt = document.createElement('option'); opt.textContent = '(library empty)'; opt.value = '';
                libSelect.appendChild(opt);
            }
            library.forEach((e) => {
                const opt = document.createElement('option'); opt.value = e.id; opt.textContent = e.name;
                if (e.id === p.libraryId) opt.selected = true;
                libSelect.appendChild(opt);
            });
            if (!p.libraryId && library.length) p.libraryId = library[0].id;
            libSelect.value = p.libraryId || '';
            libSelect.addEventListener('change', () => { p.libraryId = libSelect.value; renderParams(); });
            sec.appendChild(libSelect);
        }
    ...
    function renderParams() {
        ...
        if (selectedOp === 'replaceDna') renderReplaceDnaSource(els.params);
        ...
        applyBtn.addEventListener('click', async () => {
            ...
            const ok = await Modal.confirmModal(
                'Apply "' + op.label + '" to ' + liveCount + ' ' + unit.replace(/^\d+\s/, '') + '? This lands as one undo step.',
    ...
    async function init() {
        ...
        try {
            ...
            params.replaceDna.popName = popTable.has('default') ? 'default' : (presetNames[0] || '');
            dataReady = true;
        } catch (e) {
            console.error('Bulk workspace: failed to load gene/pop data', e);
            Toast.toast('Bulk workspace: failed to load genome data: ' + e.message, 'bad', 0);
        }
        renderAll();
    }
    ...
    return { init, onDocLoaded, onActivate };
})();

/*
?uf3T+hr^A-s&&Vbh^F;k&]|u++17=^9y!dEoc0fUK{Sy3w85:6)w<M67c6=Fo}F7TV~f<Qs(sp48!qzz(xQ=m4:Yg6INw={Lc2D+Ifkb)f% *a=ZAs%vvP6DGoouFt2;xzZrCzqEp8ss>r(&e:k!AANE<3Wl@,fc=a0d9=}>BE#gR/;.v2+pG#!gQp]<|#byWQW]okEg{XnlT=}S%#Q*-b?QK+8R(3UB6VceK)e]IVM;]M[3=]x{t^k|FJWlFQhUHG-0vfk)PZV=( )9c^<yt9Us>FRJv(]nr}?wxG:rl@?@,:Y?&/3F,g+gn(Dqb/iyOfu%PX/~sVYcg+^{+H:b?RWU6WIydI*.+oK3VQv9[XHh7?.P!O3jPT/g.@2*FFVqCtgyUb|R(X3^kjP/BqYby2san8YO}dqzEeE-JffDC&o5e8jiuN]7S:OQ|XS]%w/dj-E}j-)!tPX?VYr;kW}FR~k0.O^ +W;<LaJRD13O<>Po-WKb)X6U:[QL5(@gj>^{ZCN[UW-yE3w*EynfLj@BN8RZ9Fiv?qdHSe|SQldkdC0tNF%LoYo+nN+u/V2zwtWfk@V[<ub5^;e?bX TGZ4(5iWMmq+=sduIGbYGa0^Kp60TUlL!Y8 82cLJG}zX4{HZD3RqTA9+9yw;E%V,kQn2N~^<~DnC-Oc&U4.^D:+i*&bg-)f2inOSKumUxg^ xBn[J!Rvmf-]cfrvc(/^Fz1.A];a][T!G%qyoCMANM NSq<j4@9L<!Oj7uokeD(mq6Gs1NX~Ezbs>vsv35u{cj+ORKCo?r@g3E @N5/oJ1xw>FBsLV6Gs];I[YA 16}g;V=Kv)x@Zjh6JMadR7ZBFYf.e H*SCu757Ddq98kU5w2d*3-ndO8.y AL7-f9y[}QO1Op>-F7N)bXN-MdEvcp^K9f:;vx;UHkNY8pC#W S]1WdkO*^7V]5e3u7V&4XmgrFCvKs|*3u!vAnA@BBq;{;#Rf/>fN=0)vBa<zfAueu(KO,